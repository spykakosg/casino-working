...
function renderSymbol(key) {
  ...
  if (key === "sol") {
    return (
      <div className="cf-symbol cf-sol">
        <div className="cf-sol-bars"><span /><span /><span /></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#02040d]">
      ...
      <style jsx>{`
        ...
        .cf-panel{min-width:0;min-height:0;border:2px solid rgba(76,156,255,.72);background:linear-gradient(180deg,rgba(17,29,70,.82),rgba(5,8,27,.9));box-shadow:inset 0 0 28px rgba(0,202,255,.12),0 0 22px rgba(34,120,255,.16)}
        ...
        .cf-reels{position:relative;border-radius:17px;overflow:hidden;padding:7px;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));grid-template-rows:repeat(3,minmax(0,1fr));gap:5px;background:linear-gradient(180deg,rgba(15,34,80,.84),rgba(3,6,20,.95));border-color:rgba(78,164,255,.85)}
        ...
        .cf-bottomPanel{border-radius:15px;display:flex;align-items:center;justify-content:center;gap:10px;text-align:center;padding:6px}.cf-bottomLabel{font-size:clamp(9px,1.08vw,18px);font-weight:900;text-transform:uppercase;color:#b5c4ff}.cf-bottomVal{font-size:clamp(14px,1.85vw,31px);line-height:1.05;font-weight:900;color:#f0f5ff}.cf-token{width:clamp(31px,3.6vw,58px);aspect-ratio:1;border-radius:50%;display:grid;place-items:center;background:linear-gradient(135deg,#2dffad,#00694b);box-shadow:0 0 18px rgba(45,255,173,.55),inset 0 3px 8px rgba(255,255,255,.25);font-size:clamp(19px,2.35vw,36px);font-weight:900;flex:0 0 auto}.cf-betBtn{width:clamp(30px,3.2vw,52px);height:58%;border:1px solid rgba(141,169,255,.6);border-radius:11px;background:linear-gradient(#3c55a7,#111731);box-shadow:0 0 13px rgba(76,132,255,.2);color:white;font-size:clamp(19px,2.25vw,32px);font-weight:900;cursor:pointer}.cf-spin{width:min(84%,110px);aspect-ratio:1;border-radius:50%;border:5px solid #67c7ff;background:radial-gradient(circle,#2670f4,#071026 72%);color:white;font-size:clamp(32px,4.7vw,62px);cursor:pointer;box-shadow:0 0 30px rgba(87,190,255,.82),inset 0 0 22px rgba(255,255,255,.22);transition:.15s}.cf-spin:hover{filter:brightness(1.15);transform:scale(1.04)}.cf-spin:disabled{opacity:.55;cursor:not-allowed}.cf-auto{color:white;cursor:pointer}.cf-auto.on{border-color:#ffad3b;box-shadow:0 0 24px rgba(255,143,0,.7)}.cf-winPanel{border-color:#ffad3b;background:linear-gradient(180deg,rgba(50,27,8,.92),rgba(19,8,28,.94));clip-path:polygon(9% 0,100% 0,94% 50%,100% 100%,9% 100%,0 50%)}.cf-winPanel .cf-bottomVal{font-size:clamp(22px,3.7vw,62px);color:#ffd15b;text-shadow:0 0 18px rgba(255,187,0,.9)}
        button{font:inherit}
